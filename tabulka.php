...
?>
	...
	<a href="http://localhost/magyerka/tabulka.php?jazyk=sk">SK</a>
	<a href="http://localhost/magyerka/tabulka.php?jazyk=en">EN</a>
...
// Create connection
$conn = mysqli_connect($servername, $username, $password, "magyerka");
